...
class GameWindow < Gosu::Window
  ...
  def draw
    ...
    @font.draw("Cycle count: #{@cycle}", 10, 10, z = ZOrder::MIDDLE, 1.0, 1.0, Gosu::Color::BLACK)
    Gosu.draw_rect(@shape_x, 30, 10, 10, Gosu::Color::BLACK, ZOrder::TOP, mode=:default)
    Gosu.draw_rect(@shape_fast, 80, 10, 10, Gosu::Color::BLACK, ZOrder::TOP, mode=:default)
    Gosu.draw_rect(@shape_end, 120, 10, 10, Gosu::Color::BLACK, ZOrder::TOP, mode=:default)
    puts("2. In draw\n")
  end
end
